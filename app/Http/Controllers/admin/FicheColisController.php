...
public function add_colis_fiche(Request $request){
 ...
 $CountColis = FicheColis::leftJoin('stats_colis','stats_colis.id_colis','=','fiche_fields.id_colis')->where('id_fiche','=',$idfiche)->where('fiche_fields.id_colis','=',$idcolis)->where('stats_colis.id_stats','=',4)->count();
