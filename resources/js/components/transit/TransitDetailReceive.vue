...
<div>
  ...
  <div   class="checkbox d-inline">
                                    <input  v-if="col.approved == 1 "  type="checkbox" name="checkbox-fill-1" :id="'checkbox-'+col.id_colis"  checked >
                                                                        <input  v-else  type="checkbox" name="checkbox-fill-1" :id="'checkbox-'+col.id_colis"  >
...
axios.patch('/api/unselectcoltrans/'+tran).then(
 this.getColis(),
this.codebars = ''
...
var tran = valObjValid[0].id_trans ; 
...
axios.patch('/api/approvcoltrans/'+tran).then( response =>
     { 
       this.getColis();
         this.codebars = ''
