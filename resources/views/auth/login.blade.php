                        ...
                        <div class="row justify-content-center">
                            <div class="col-sm-10">
                                <form method="POST" action="{{ route('login') }}">
                                    @csrf 
                                <h3 class="mb-4" style="color:#6a737b;">Connectez-vous <i class="fas fa-sign-in-alt"></i> </h3>
                                ...
                                <button type="submit" class="btn btn-primary shadow-2 mb-4">   {{ __('Inscrivez') }}</button>
                            <p class="mb-0 text-muted">vous avez un compte déja ? <a href="{{ url('/register')}}"> inscrivez-vous</a></p>
                            </div>
                        </form>
                        </div>
                    </div>
