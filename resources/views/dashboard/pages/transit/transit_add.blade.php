...
@include('dashboard.partials.filtrenavs.navfiltre_add_transit')
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                      ...
                                      <th class="text-center"   > 35000 DA   </th>
                                        ...
                                        <td class="text-center"> <button class="btn btn-square btn-danger"><i  style="margin:0px;" class="fas fa-times-circle"></i> </button> </td>
                                    </tr>
