            ...
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-header">
                        <h5 style="margin-bottom:3%;"><span class="pcoded-badge label label-info">#Froute-0438340   <i class="fas fa-list"></i> </span> </h5>
...
@include('dashboard.partials.filtrenavs.navfiltre_ondelivery_list')
        ...
        <tbody>
            <tr>
                <th scope="" class="" >
                    <div class="form-group">
                        <div class="checkbox checkbox-fill d-inline">
                            ...
                            <label for="checkbox-fill-1" class="cr"></label>
                        </div>
                    </div>
                </th>
              ...
              <th class="text-center"   > 35000 DA   </th>
                ...
                <td class="text-center" ><span class="pcoded-badge label label-warning">en attente   <i class="fas fa-hourglass-half"></i> </span></td>

                <td class="text-center"> <button class="btn btn-square btn-danger"><i  style="margin:0px;" class="fas fa-times-circle"></i> </button> <button class="btn btn-square btn-success"><i style="margin:0px;"  class="fas fa-check-circle"></i> </button> </td>
            </tr>
            <tr>
                <th scope="" class="" >
                    <div class="form-group">
                        <div class="checkbox checkbox-fill d-inline">
                            <input type="checkbox" name="checkbox-fill-1" id="checkbox-fill-1" >
                            <label for="checkbox-fill-1" class="cr"></label>
                        </div>
                    </div>
                </th>
