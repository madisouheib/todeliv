...
<div class="row">
    ...
    <div class="col-4">
    <button class="btn btn-square btn-outline-success" style=""> Valider les encaissements   <i class="fas fa-money-bill-wave" ></i></button>
    </div>
    ...
    <div class="row"> 
                            ...
                            <option value="1">Sarl X </option>
                            <option value="2">Sarl Y  </option>
                            <option value="3">Sarl V  </option>
                            </select>
                            ...
                            <select class="custom-select" required>
                            <option value="">Mise a jour  </option>
                            <option value="1">Client injoignable </option>
                            <option value="1">Reporté par le client</option>
                            ...
                            <select class="custom-select" required>
                            <option value="">Feullies de routes </option>
                            <option value="1">F-route 1 </option>
                            <option value="1">F-route 2  </option>
                            <option value="1">F-route 3 </option>
                            <option value="1">F-route 4  </option>
                            </select>
                                         <div class="invalid-feedback">
                                            Please choose a type.
                                        </div>
